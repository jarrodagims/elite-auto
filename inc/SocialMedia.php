...
class SocialMedia {
	...
	private function setupSingle($bob = string) {
		...
		return "<a href=\"$url\" class=\"$bob-button social-media-button " . $this->getSize() . ' ' . $this->getStyle() . ' ' . $this->getColorType() . " external\" target=\"_blank\"><i class=\"fab fa-" . $icon . " fa-fw $size_class\"><span>" . $name . "</span></i></a>";
	}
